...
\exercisetitle{Defectos de Schottky}
...
%~ Teniendo en cuenta que los átomos localizados en los vertices de la 
%~ red cristalina minimiza la energía del sistema, ¿cómo puede 
%~ interpretar el hecho de que la red presente defectos puntuales a 
%~ temperatura distinta de cero si cada defecto puntual implica un 
%~ costo energético?
