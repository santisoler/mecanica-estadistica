...
microscópica. Los átomos situados en los nodos de una red cristalina 
pueden presentar electrones sin aparear. Al igual que cualquier 
partícula elemental, los electrones presentan un momento angular 
...
\begin{enumerate}[label=(\alph*),
    ...
    $$ B_s(x)  = \left( 1 + \frac{1}{2s} \right)
    \coth \left[ \left( 1 + \frac{1}{2s} \right)x \right] -
    \frac{1}{2s} \coth \left( \frac{x}{2s} \right) $$
    }
