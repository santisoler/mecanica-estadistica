...
\begin{enumerate}[label=(\alph*),
    ...
    donde $g(e)$ es la densidad de estados, es decir la cantidad de 
...
Como hemos visto en la práctica anterior, un paramagneto puede ser 
...
$$ E = - \boldsymbol{\mu} \cdot \textbf{H} = - \mu H \cos \theta $$
...
\begin{enumerate}[label=(\alph*),
    ...
    \item{Obtener la función de partición de todo el paramagneto.}
    ...
    - S dT$) y utilizar la expresión de la energía total del sistema 
    ($ E = - \textbf{M} \cdot \textbf{H} \simeq - MH$).
    }
    ...
    \item{Calcular el calor específico del paramagneto y analizar sus 
          comportamientos a altas y bajas temperaturas. ¿Este 
          resultado satisface el Tercer Principio de la Termodinámica?}


\end{enumerate}

\section{Paramagnetismo de Langevin cuántico}
