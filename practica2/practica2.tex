...
allá del \emph{spin} 1/2 como el que analizamos en el problema 
anterior. En el caso más general, su momento angular total 
($\hat{\textbf{J}}$) puede calcularse como la suma entre el momento 
angular orbital ($\hat{\textbf{L}}$) y el momento angular intrínseco 
(de spin $\hat{\textbf{S}}$):

$$ \hat{\textbf{J}} = \hat{\textbf{L}} + \hat{\textbf{S}} $$

El hamiltoniano de un átomo con momento angular total 
$\hat{\textbf{J}}$ inmerso en un campo magnético puede escribirse como:
...
\begin{enumerate}[label=(\alph*),
    ...
    \item{Realizar una gráfica de la magnetización del paramagneto 
          para $J = 3/2$, $5/2$ y $7/2$. Suponer que $g = 2$ en los 
          tres casos.}
