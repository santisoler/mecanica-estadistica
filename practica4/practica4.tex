...
pequeño orificio a través del cual ingresa la radiación electromagnética 
que es absorbida y emitida por las paredes internas de la cavidad.
...
\begin{enumerate}[label=(\alph*),
     ...
     \item{Consideremos un gas de fotones dentro de una caja de volumen $V$.
           La energía de cada fotón puede escribirse como:
           $$ \epsilon = \hbar \omega = c p , $$
           mientras que los autovalores de los momentos de cada fotón puede 
           escribirse como:
           $$
           ...
           n_x, n_y, n_z = 1, 2, 3, \dots .
           $$
           La energía de los fotones se debe a su propia naturaleza, mientras 
           que la discretización de los niveles de energía viene dada por 
           las condiciones de contorno en las paredes de la cavidad.
           Obtener la fórmula de Planck: la energía por unidad de volumen 
           ...
           $$
           Esta expresión se conoce como la \emph{densidad espectral} del 
           cuerpo negro.
           }
