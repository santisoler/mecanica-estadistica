...
Considere una partícula que puede acceder a dos niveles de energía ($\epsilon_1 = 1$eV
y $\epsilon_2 = 2$eV) situada en un baño térmico a una temperatura $T$.
...
\begin{enumerate}[label=(\alph*),
    ...
    \item{Determine las probabilidades de hallar a la partícula en el nivel $\epsilon_1$
          y $\epsilon_2$ en caso de que $T =$ 1K, 100K, 300K y 1000K. Interprete estos
          resultados microscópicamente.}
